(function() {
  ...
  angular
    .module('inspinia', ['ngAnimate', 'ngCookies', 'ngTouch', 'ngSanitize', 'ngRoute', 'ngMessages', 'ngAria', 'ngResource', 'ui.router', 'oc.lazyLoad', 'ui.calendar', 'ui.bootstrap', 'ui.select', 'ladda', 'ngFileUpload']);
