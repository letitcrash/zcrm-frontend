...
'use strict';
angular.module('inspinia').controller("UserCtrl", function($scope, requestService, employeeService, passwordServices, workplaceService, periodService, generalUtils, dataService, $q, $timeout) {
